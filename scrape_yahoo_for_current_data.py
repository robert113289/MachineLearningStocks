...
def Check_Yahoo():
    ...
    for e in stock_list[1:]:
        ...
        try:
            e = e.replace("C:/dev_tools/workspace/Secondary/MachineLearningStocks/intraQuarter/_KeyStats\\", "")
            print(e)
    ...
    for each_file in file_list:
        ...
        try:
            ...
            if value_list.count("N/A") > 15:
                print("To many N/A.. moving on..")
                pass

            else:
                print(str(value_list))
                date_stamp = datetime.date.today()
                date_stamp_str = date_stamp.strftime('%Y-%m-%d')
                stock_p_change = "N/A"
                sp500_p_change = "N/A"
                difference = "N/A"
                df = df.append({'Date': date_stamp_str,
                                ...
                                # Multiplying Shares Outstanding * Current Price to determine Market Cap
